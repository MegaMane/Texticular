...
namespace Texticular.GameEngine
{
    public class Story
    {
        ...
        public Story()
        {
            ...
            {
                { "intro",  new Scene(new List<String> {"You wake up disoriented with a pounding headache in a shabby looking hotel room "
                                    + "surrounded by a bunch of empty cans. You've got a taste in your mouth like a dirty old rat "
                                    + "crawled in and died in there. Disoriented, you roll out of the bed you woke up in, barely avoiding "
                                    + "some questionable stains on the sheets, as you stumble to your feet sending cans flying like bowling "
                                    + "pins in your wake. You bend over to take a closer look at the pile of crushed aluminum. You read one "
                                    + "of the labels: \"Fast Eddie's Colon Cleanse: When in doubt flush it out!\" "
                                    ...
                                    + "spend some of that hard earned cash!You reach into your wallet and realize in that moment that you don't even remember your name. "
                                    + "You look at your license and focus your still hazy eyes and barely make out that it says....\n",
        ...
        void intro(GameController controller)
        {
            Player player = controller.game.Player;
            
            if (player.FirstName == null)
            {
                controller.InputResponse.Append(Scenes["intro"].SceneText);
            }
            

            //player.Name = controller.UserInput;
            //controller.InputResponse.Append($"Hello {player.Name}");
    ...
    public class Scene
    {
        ...
        public Scene(List<String> sceneText, Action<GameController> sceneAction)
        {
            SceneText = sceneText;
